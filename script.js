...
createSoundButton('ENFADO', '9JEFEENFADADO.mp3', 'r');
createSoundButton('ORACION', '10ORACION.mp3', 't');
createSoundButton('CIELO', '11CIELO.mp3', 'y');
createSoundButton('ALELUYA', '10.1ALELUYA.mp3', 'u');
createSoundButton('SUSURROS', '12SUSURROS.mp3', 'i');
createSoundButton('CIERRE LIBRO', '13LIBRO.mp3', 'o');
createSoundButton('CIELO', '14CIELO.mp3', 'p');
createSoundButton('SUSURROS', '15SUSURROS.mp3', 'a');
createSoundButton('CAMPANAS', '16CAMPANAS.mp3', 's');
createSoundButton('OFRENDA', '17OFRENDA.mp3', 'd');
createSoundButton('TRISTEZA', '18TRISTEZA.mp3', 'f');
createSoundButton('SAD', '18SAD.mp3', 'g');
