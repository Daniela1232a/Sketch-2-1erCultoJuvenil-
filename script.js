...
createSoundButton('RESTAURANTE 1', 'RESTAURANT.mp3', '8');
createSoundButton('RESTAURANTE 2', '5.1RESTAURANTE .mp3', '9');
createSoundButton('RISAS', '6RISAS.mp3','q');
createSoundButton('CHARLA', '6.1CHARLA.mp3', 'w');
createSoundButton('NO COMIDA', '7NONO.mp3', 'e');
createSoundButton('BARRIGA', '8TRIPAS.mp3', 'r');
...
createSoundButton('ALELUYA', '10.1ALELUYA.mp3', 'i');
createSoundButton('CORO', 'COROSANTO.mp3', 'o');
createSoundButton('MONEDA', 'MONEDA.mp3', 'p');
...
createSoundButton('TRISTEZA', '18TRISTEZA.mp3', 'j');
